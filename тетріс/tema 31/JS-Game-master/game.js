...
function Update() {
    ...
    if (RandomInteger(0, 100) > 95) //Generating new car
    {
        objects.push(new Car("images/car_red.png", RandomInteger(30, canvas.width - 50), /* RandomInteger(250, 400) * -1*/ 0 - player.image.height, false));
    }
